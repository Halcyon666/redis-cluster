 ...
 * <p>
 * <br/><a href="https://github.com/JustryDeng/PublicRepository/tree/master/Abc_RequestBodyAndRequestParam">code from </a>
 */
@RestController
public class RequestTestController {
    ...
    /**
     * @return
     * @RequestBody装配请求体重的信息; 第二个参数不加注解, 装配url中的参数信息
    ...
    /**
     * @param user   用户实体类模型
     * @param arrays 从'key-value'中获取到的集合数组
     * @return
