...
/**
 * @Author: WhaleFall541
 * @Date: 2021/10/6 18:36
 */
public class Test4MethodAnnotationValue {
    public static void main(String[] args) throws Exception {
        Method[] methods = Member.Normal.class.getMethods();
        for (Method m: methods) {
            if ("testMth".equals(m.getName())) {
                Annotation annotation = m.getAnnotation(MemberLevel.class);
    ...
    public static Object getAnnotationValue(Annotation annotation, String property) {
        ...
        if (annotation != null) {
            ...
            HashMap map = (HashMap) getFieldValue(invo, "memberValues");
            if (map != null) {
